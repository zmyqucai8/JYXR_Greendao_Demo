...
import com.example.zhangmengyun.greedaodemo.adapter.MemberAdapter;
...
public class ProjectRoomMemeberPop extends PopupWindow {
    ...
    public ProjectRoomMemeberPop(@NonNull final Context context, List<MemberBean> list, String roomName) {
        super(context);
    ...
    public void initData(List<MemberBean> list) {
        //获取当前账户消息数据
...
//        }
        adapter = new MemberAdapter(context, list);
