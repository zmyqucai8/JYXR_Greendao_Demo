...
public class HaoYouFragment extends Fragment implements View.OnClickListener {
    ...
    List<UserBean> haoYouList;
    YongHuAdapter adapter;

    public void initData() {
        //获取当前账户消息数据
        AccountBean currentAccount = DaoUtils.getCurrentAccount();
        haoYouList = currentAccount.getHaoYouList();
        if (null == haoYouList) {
            haoYouList = new ArrayList<>();
        }
        adapter = new YongHuAdapter(this, haoYouList);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_add:
                //添加一条
                UserBean userBean = TestUtlis.createUser(true);
